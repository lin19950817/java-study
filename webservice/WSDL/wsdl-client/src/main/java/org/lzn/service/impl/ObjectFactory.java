 ...
 * generated in the org.lzn.service.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://impl.service.lzn.org/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://impl.service.lzn.org/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.lzn.service.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.lzn.org/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.lzn.org/", name = "queryWeatherResponse")
